...
/* LoadBalancerControllerApiService list
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param application application
 @return []LoadBalancer*/
func (a *LoadBalancerControllerApiService) ListUsingGET5(ctx context.Context, application string) ([]LoadBalancer,  *http.Response, error) {
	var (
