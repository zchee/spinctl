...
/* InstanceControllerApiService getConsoleOutput
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return interface{}*/
func (a *InstanceControllerApiService) GetConsoleOutputUsingGET(ctx context.Context, account string, region string, id string, localVarOptionals map[string]interface{}) (interface{},  *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/instances/{account}/{region}/{id}/console"
...
/* InstanceControllerApiService getInstance
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param account account
 @param region region
 @param id id
 @return Instance*/
func (a *InstanceControllerApiService) GetInstanceUsingGET(ctx context.Context, account string, region string, id string) (Instance,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/instances/{account}/{region}/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"account"+"}", fmt.Sprintf("%v", account), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"region"+"}", fmt.Sprintf("%v", region), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
