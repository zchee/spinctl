...
func (r apiSearchRequest) XRateLimitApp(xRateLimitApp string) apiSearchRequest {
	r.xRateLimitApp = &xRateLimitApp
	return r
}

func (r apiSearchRequest) AllowShortQuery(allowShortQuery bool) apiSearchRequest {
...
func (r apiSearchRequest) Platform(platform string) apiSearchRequest {
	r.platform = &platform
	return r
}
...
*/
func (a *SearchControllerApiService) Search(ctx _context.Context) apiSearchRequest {
	return apiSearchRequest{
		apiService: a,
		ctx:        ctx,
	}
...
*/
func (r apiSearchRequest) Execute() ([]map[string]interface{}, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "SearchControllerApiService.Search")
	if err != nil {
