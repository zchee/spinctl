...
func (r apiGetJobRequest) XRateLimitApp(xRateLimitApp string) apiGetJobRequest {
	r.xRateLimitApp = &xRateLimitApp
	return r
}

func (r apiGetJobRequest) Expand(expand string) apiGetJobRequest {
	r.expand = &expand
	return r
}
...
*/
func (a *JobControllerApiService) GetJob(ctx _context.Context, account string, applicationName string, name string, region string) apiGetJobRequest {
	return apiGetJobRequest{
		apiService:      a,
		ctx:             ctx,
		account:         account,
...
*/
func (r apiGetJobRequest) Execute() (map[string]map[string]interface{}, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "JobControllerApiService.GetJob")
	if err != nil {
