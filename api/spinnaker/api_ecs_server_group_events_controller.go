...
func (r apiListEventsRequest) Provider(provider string) apiListEventsRequest {
	r.provider = &provider
	return r
}

func (r apiListEventsRequest) Region(region string) apiListEventsRequest {
	r.region = &region
	return r
}

/*
ListEvents Retrieves a list of events for a server group
...
*/
func (a *EcsServerGroupEventsControllerApiService) ListEvents(ctx _context.Context, account string, application string, serverGroupName string) apiListEventsRequest {
	return apiListEventsRequest{
		apiService:      a,
		ctx:             ctx,
		account:         account,
...
func (r apiListEventsRequest) Execute() ([]map[string]interface{}, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "EcsServerGroupEventsControllerApiService.ListEvents")
	if err != nil {
