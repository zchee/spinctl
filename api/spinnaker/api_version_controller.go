...
*/
func (a *VersionControllerApiService) GetVersion(ctx _context.Context) apiGetVersionRequest {
	return apiGetVersionRequest{
		apiService: a,
		ctx:        ctx,
	}
...
Execute executes the request
 @return Version
*/
func (r apiGetVersionRequest) Execute() (Version, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "VersionControllerApiService.GetVersion")
	if err != nil {
