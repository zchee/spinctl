...
func (a *V2CanaryConfigControllerApiService) UpdateCanaryConfigUsingPUT(ctx context.Context, id string, config interface{}, localVarOptionals *UpdateCanaryConfigUsingPUTOpts) (interface{}, *http.Response, error) {
	var (
