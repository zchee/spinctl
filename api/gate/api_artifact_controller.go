...
func (a *ArtifactControllerApiService) ArtifactVersionsUsingGET(ctx context.Context, accountName string, type_ string, artifactName string, localVarOptionals *ArtifactVersionsUsingGETOpts) ([]string, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
