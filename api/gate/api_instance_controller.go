...
func (a *InstanceControllerApiService) GetConsoleOutputUsingGET(ctx context.Context, account string, region string, instanceId string, localVarOptionals *GetConsoleOutputUsingGETOpts) (interface{}, *http.Response, error) {
	var (
...
func (a *InstanceControllerApiService) GetInstanceDetailsUsingGET(ctx context.Context, account string, region string, instanceId string, localVarOptionals *GetInstanceDetailsUsingGETOpts) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
