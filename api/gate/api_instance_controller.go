...
func (a *InstanceControllerApiService) GetConsoleOutputUsingGET(ctx _context.Context, account string, region string, instanceId string, localVarOptionals *GetConsoleOutputUsingGETOpts) (map[string]interface{}, *_nethttp.Response, error) {
	var (
...
func (a *InstanceControllerApiService) GetInstanceDetailsUsingGET(ctx _context.Context, account string, region string, instanceId string, localVarOptionals *GetInstanceDetailsUsingGETOpts) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHttpMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
