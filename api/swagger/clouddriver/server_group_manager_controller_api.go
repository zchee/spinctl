...
/* ServerGroupManagerControllerApiService getForApplication
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param application application
 @return []ServerGroupManager*/
func (a *ServerGroupManagerControllerApiService) GetForApplicationUsingGET(ctx context.Context, application string) ([]ServerGroupManager,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  []ServerGroupManager
	)
