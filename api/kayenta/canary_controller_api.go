...
type CanaryControllerApiService service


/* CanaryControllerApiService Retrieve a list of an application&#39;s canary results
...
func (a *CanaryControllerApiService) GetCanaryResultsByApplicationUsingGET(ctx context.Context, localVarOptionals map[string]interface{}) ([]CanaryExecutionStatusResponse,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  []CanaryExecutionStatusResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/canary/executions"
...
/* CanaryControllerApiService Retrieve status and results for a canary run
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param canaryExecutionId canaryExecutionId
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "storageAccountName" (string) storageAccountName
 @return CanaryExecutionStatusResponse*/
func (a *CanaryControllerApiService) GetCanaryResultsUsingGET(ctx context.Context, canaryExecutionId string, localVarOptionals map[string]interface{}) (CanaryExecutionStatusResponse,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/canary/{canaryExecutionId}"
...
/* CanaryControllerApiService Initiate a canary pipeline
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "storageAccountName" (string) storageAccountName
     @param "canaryExecutionRequest" (CanaryExecutionRequest) canaryExecutionRequest
 @return CanaryExecutionResponse*/
func (a *CanaryControllerApiService) InitiateCanaryUsingPOST(ctx context.Context, canaryConfigId string, localVarOptionals map[string]interface{}) (CanaryExecutionResponse,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  CanaryExecutionResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/canary/{canaryConfigId}"
	...
	// body params
	if localVarTempParam, localVarOk := localVarOptionals["canaryExecutionRequest"].(CanaryExecutionRequest); localVarOk {
...
/* CanaryControllerApiService Initiate a canary pipeline with CanaryConfig provided
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "metricsAccountName" (string) metricsAccountName
     @param "storageAccountName" (string) storageAccountName
     @param "canaryAdhocExecutionRequest" (CanaryAdhocExecutionRequest) canaryAdhocExecutionRequest
 @return CanaryExecutionResponse*/
func (a *CanaryControllerApiService) InitiateCanaryWithConfigUsingPOST(ctx context.Context, localVarOptionals map[string]interface{}) (CanaryExecutionResponse,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody interface{}
		localVarFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/canary"
	...
	// body params
	if localVarTempParam, localVarOk := localVarOptionals["canaryAdhocExecutionRequest"].(CanaryAdhocExecutionRequest); localVarOk {
		localVarPostBody = &localVarTempParam
	}
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
	if err != nil {
