...
type MetricsServiceMetadataControllerApiService service


/* MetricsServiceMetadataControllerApiService Retrieve a list of descriptors for use in populating the canary config ui
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "metricsAccountName" (string) metricsAccountName
     @param "filter" (string) filter
 @return []ModelMap*/
func (a *MetricsServiceMetadataControllerApiService) ListMetadataUsingGET(ctx context.Context, localVarOptionals map[string]interface{}) ([]ModelMap,  *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/metadata/metricsService"
